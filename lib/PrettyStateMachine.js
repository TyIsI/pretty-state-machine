...
function PrettyStateMachine () {
  this.consumers = new EventEmitter2({ wildcard: false })
  this.defaultTopic = 'state'
  this.store = localStorage.getItem('prettystatemachine') !== null ? JSON.parse(localStorage.getItem('prettystatemachine')) : { [this.defaultTopic]: {} }
}
...
module.exports = { ...stateMachine, ...{ stateMachine, PrettyStateMachine } }
